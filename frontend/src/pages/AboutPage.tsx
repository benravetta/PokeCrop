...
import { ESTIMATE_DISCLAIMER, SEO } from "../lib/marketingCopy";
    ...
    <MarketingPageShell>
      ...
      <div className="mt-10 space-y-6 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2">
            We do not issue official grades. We are not affiliated with PSA, Beckett, CGC or any
            other grading company. We estimate and explain — the grader decides the final slab.
          </p>
        </section>
        <section>
