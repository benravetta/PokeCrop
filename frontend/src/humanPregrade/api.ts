...
export async function fetchHumanPregradeConfig(): Promise<HumanPregradeConfig | null> {
  const res = await fetch(`${BASE}/human-pregrades/config`, { headers: await authHeaders() });
...
export async function createHumanPregradeOrder(body: Record<string, unknown>) {
  const res = await fetch(`${BASE}/human-pregrades`, {
    method: "POST",
...
export async function listHumanPregradeOrders(
  ...
  const res = await fetch(`${BASE}/human-pregrades${qs ? `?${qs}` : ""}`, {
...
export async function getHumanPregradeOrder(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}`, { headers: await authHeaders() });
  if (!res.ok) await fail(res);
  return res.json();
}

export async function getHumanPregradeStatus(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/status`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
...
export async function getHumanPregradeTimeline(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/timeline`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
...
export async function listHumanPregradeMessages(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/messages`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
...
export async function patchHumanPregradeDraft(publicId: string, body: Record<string, unknown>) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/draft`, {
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
    body: JSON.stringify(body),
  });
...
export async function uploadHumanPregradeImage(
  ...
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/images`, {
    method: "POST",
    headers: await authHeaders(),
    body: fd,
  });
...
export async function startHumanPregradeCheckout(publicId: string): Promise<{ url: string }> {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/checkout`, {
    method: "POST",
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
...
export async function submitHumanPregradeOrder(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/submit`, {
    method: "POST",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
...
export async function getHumanPregradeReport(publicId: string) {
  const res = await fetch(`${BASE}/human-pregrades/${publicId}/report`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
...
export async function downloadHumanPregradeReportPdf(publicId: string): Promise<void> {
  const res = await fetch(humanPregradeReportPdfUrl(publicId), {
    headers: await authHeaders(),
    redirect: "follow",
  });
  if (!res.ok) await fail(res);
...
export async function listAdminHumanPregrades(status?: string) {
  ...
  const res = await fetch(`${BASE}/admin/human-pregrades${q}`, { headers: await authHeaders() });
  if (!res.ok) await fail(res);
  return res.json();
}

export async function getAdminHumanPregrade(id: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}`, { headers: await authHeaders() });
  if (!res.ok) await fail(res);
  return res.json();
}

export async function assignHumanPregrade(id: string, reviewerUserId: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/assign`, {
    method: "POST",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
...
export async function startHumanPregradeReview(id: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/start`, {
    method: "POST",
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
...
export async function requestHumanPregradeImages(
  ...
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/request-images`, {
    method: "POST",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
    body: JSON.stringify(body),
  });
...
export async function saveHumanPregradeAssessment(id: string, body: Record<string, unknown>) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/assessment`, {
    method: "PUT",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
    body: JSON.stringify(body),
  });
...
export async function saveHumanPregradePredictions(
  ...
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/grader-predictions`, {
    method: "PUT",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
...
export async function addHumanPregradeDefect(id: string, body: Record<string, unknown>) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/defects`, {
    method: "POST",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
    body: JSON.stringify(body),
  });
...
export async function submitHumanPregradeForCheck(id: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/submit-for-check`, {
    method: "POST",
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
...
export async function returnHumanPregradeToReviewer(id: string, note?: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/return`, {
    method: "POST",
    headers: { "Content-Type": "application/json", ...(await authHeaders()) },
...
export async function approveHumanPregrade(id: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/approve`, {
    method: "POST",
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
...
export async function getHumanPregradeReportPreview(id: string) {
  const res = await fetch(`${BASE}/admin/human-pregrades/${id}/report-preview`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
...
export async function getAdminHumanPregradeSettings() {
  const res = await fetch(`${BASE}/admin/human-pregrades/settings`, {
    headers: await authHeaders(),
  });
  if (!res.ok) await fail(res);
  return res.json();
